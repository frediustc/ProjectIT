    ...
    <?php if($page === "Add Billboards")
    { ?>
        <!-- The jQuery UI widget factory, can be omitted if jQuery UI is already included -->
        <script src="<?php echo $rep ; ?>js/vendor/jquery.ui.widget.js"></script>
        <!-- The Iframe Transport is required for browsers without support for XHR file uploads -->
        <script src="<?php echo $rep ; ?>js/jquery.iframe-transport.js"></script>
        <!-- The basic File Upload plugin -->
        <script src="<?php echo $rep ; ?>js/jquery.fileupload.js"></script>
        <!-- The File Upload processing plugin -->
        <script src="<?php echo $rep ; ?>js/jquery.fileupload-process.js"></script>
        <!-- The File Upload validation plugin -->
        <script src="<?php echo $rep ; ?>js/jquery.fileupload-validate.js"></script>
        <script>
