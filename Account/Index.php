            ...
            <div class="row">
                <div class="col-xs-12 text-center">
                    ...
                    <div class="account-info-block text-left">
                        ...
                        <p class="text-capitalize text-right"><i>Frediustc@gmail.com</i></p>
                    </div>
                    <div class="account-info-block text-left">
                    ...
                    <div class="account-info-block text-left">
                        ...
                        <p class="text-capitalize text-right"><i>Selected Password</i></p>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-xs-12">
                    <div class="row">
                        <div class="col-xs-8 col-xs-push-2">
                            <h1 class="text-capitalize">Update profile</h1>
